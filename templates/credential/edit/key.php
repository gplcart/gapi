...
<form method="post" class="form-horizontal">
  ...
  <div class="form-group<?php echo $this->error('data.key', ' has-error'); ?>">
    <label class="col-md-2 control-label"><?php echo $this->text('Key'); ?></label>
    <div class="col-md-4">
      <input name="credential[data][key]" class="form-control" value="<?php echo isset($credential['data']['key']) ? $credential['data']['key'] : ''; ?>">
      <div class="help-block">
          <?php echo $this->error('data.key'); ?>
        <div class="text-muted">
            <?php echo $this->text('An API key you got from https://console.developers.google.com/apis/credentials'); ?>
        </div>
      </div>
    </div>
  </div>
